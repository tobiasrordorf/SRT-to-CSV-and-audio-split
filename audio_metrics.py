...
print('Length of dev-set: {:10} \nLength of test-set: {:9} \nLength of train-set: {:8}\
\nLength of ch-full-set: {:7}'.format(len(dev), len(test), len(train), len(df_all)))
...
print('------------------------------------------------------------------------------------------------------')
print('Average length of CH audio is: {} seconds.'.format(round(avg_length, 1)))
print('Total length of CH audio in seconds is: {} seconds.'.format(round(sum, 1)))
print('Total length of CH audio is: {}'.format(length_of_audio))
print('------------------------------------------------------------------------------------------------------')
